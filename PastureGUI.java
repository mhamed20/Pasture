...
public class PastureGUI extends JFrame implements ActionListener {
	...
	/**
	 * This method is called when an action event has occured and carries out the
	 * correct actions depending on the event. In this class, this means that
	 * someone has pressed any of the buttons start, stop, or exit.
	 */
	...
	/**
	 * The method addEntity is called to notify the GUI that an entity has been
	 * added to a position. The icon of the added entity is displayed at the
	 * position.
	 */
	...
	/**
	 * The method removeEntity is called to notify the GUI that an entity has been
	 * removed from a position. One icon among the icons of the remaining entities
